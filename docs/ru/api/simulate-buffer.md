...
*Одна контрольная точка — Apple M1, Node 22, прогретый JIT. Все три модели работают примерно на ~3.5 Mpix/s; попиксельная CIE xyY-проекция Brettel всего на ~15–20% медленнее матричного пути, а не на несколько×, как можно было бы ожидать исходя из её преимущества в точности.*
