...
Функция обрабатывает по 4 байта за раз без аллокаций внутри горячего цикла. Производительность масштабируется линейно с количеством пикселей:

| Разрешение | Пиксели | Machado | Brettel |
|---|---|---|---|
| 640×480 | 307K | ~2мс | ~8мс |
| 1920×1080 | 2.1M | ~12мс | ~45мс |
| 3840×2160 | 8.3M | ~50мс | ~180мс |

*Измерено на Apple M1, один поток. Ваши результаты могут отличаться.*
