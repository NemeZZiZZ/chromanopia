...
function apiSidebar(prefix: string, labels: { api: string; types: string }): DefaultTheme.SidebarItem[] {
  return [
    {
      text: labels.api,
      items: [
...
export default defineConfig({
    ...
    ru: {
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/ru/api/": apiSidebar("/ru", { api: "Справочник API", types: "Типы и метаданные" }),
        },
      },
    },
    sr: {
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/sr/api/": apiSidebar("/sr", { api: "API referenca", types: "Tipovi i metapodaci" }),
        },
      },
    },
    zh: {
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/zh/api/": apiSidebar("/zh", { api: "API 参考", types: "类型与元数据" }),
        },
      },
    },
    ja: {
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/ja/api/": apiSidebar("/ja", { api: "APIリファレンス", types: "型とメタデータ" }),
        },
      },
    },
    es: {
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          "/es/api/": apiSidebar("/es", { api: "Referencia API", types: "Tipos y metadatos" }),
        },
      },
    },
  },
  themeConfig: {
    ...
    sidebar: {
      ...
      "/api/": apiSidebar("", { api: "API Reference", types: "Types & Metadata" }),
    },
    socialLinks: [
